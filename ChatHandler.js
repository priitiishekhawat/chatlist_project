/**
 * Created by Priti Shekhawat 
 */

export { ChatHandler, chat_names}

const chat_names = ["Priti Shekhawat", "Aditya", "Riya", "Prachi", "Prashant", "Riddhi","Vansh" ,"Riya Jain"];
const chat_names_length = chat_names.length;
const chat_msg = ["Good morning , how you doing... ",
    "Hey, have you completed your cs assignment",
    "Perfect, I am really glad to hear that!...",
    "hey ,sorry for late replying....",
    "I was just thinking to go for a trip....",
...
class ChatHandler{
    ...
    createNode(id){
        ...
        console.log("./images/img" + eval(1+(id%chat_img_length)) + ".png");
        chat_item.querySelector('#Image').src = "./images/img" + eval(1+(id%chat_img_length)) + ".jpg";
